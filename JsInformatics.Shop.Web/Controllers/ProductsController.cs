...
namespace JsInformatics.Shop.Web.Controllers
{
    using System;
    using System.IO;
    ...
    using Data.Entities;
    using Helpers;
    using JsInformatics.Shop.Web.Models;
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create(ProductViewModel view)
        {
            if (ModelState.IsValid)
            {
                ...
                product.User = await this.userHelper.GetUserByEmailAsync("jsanabria93310@gmail.com");
